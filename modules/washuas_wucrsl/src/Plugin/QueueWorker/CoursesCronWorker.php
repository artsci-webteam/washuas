...
namespace Drupal\washuas_wucrsl\Plugin\QueueWorker;
 ...
 *
 * @QueueWorker(
 *   id = "courses_cron_import",
 *   title = @Translation("Courses Cron SOAP Import"),
 *   cron = {"time" = 480}
 * )
 *
 * @see washuas_wucrsl_cron()
 */
class CoursesCronWorker extends QueueWorkerBase implements ContainerFactoryPluginInterface {
